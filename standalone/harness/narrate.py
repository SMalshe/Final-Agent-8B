...
LINES = {
    ...
    "list_sent":           ("Checking what you have sent", "Checked your sent mail"),
    "list_drafts":         ("Checking your drafts", "Checked your drafts"),
    "read_draft":          ("Opening that draft", "Read the draft"),
    "save_draft":          ("Drafting a note to {to}", "Left a draft for {to}"),
